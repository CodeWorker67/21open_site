...
import { BRAND_NAME, PAYMENT_METHODS, ROUTES, TRAFFIC_PACKAGES } from '@utils/constants';
...
export default function TrafficBuyPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Докупка трафика — {BRAND_NAME}</title>
        <meta
          name="description"
          content={`Дополнительные пакеты трафика для мобильного доступа к ${BRAND_NAME}. Оплата СБП или картой РФ.`}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Пакеты для сервера с надёжным доступом на мобильном интернете. Нужна активная подписка PRO.
            </p>
          </motion.div>
